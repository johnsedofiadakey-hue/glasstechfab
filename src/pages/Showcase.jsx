...
const PROJECTS = [
  ...
  // WARDROBES & JOINERY
  {
    ...
    desc: 'A hotel-grade master suite featuring bespoke cream tufted wall panels flanked by dark fluted timber pilasters — a signature Glasstech architectural detail. The crystal chandelier, plush bench and sheer curtains create a refined retreat that balances warmth with grandeur.',
  },
  {
...
function Lightbox({ project, onClose, onPrev, onNext, brand }) {
  ...
  const waText = `Hi Glasstech! I saw your "${project.title}" in the showroom and I'd like to get something similar. Can we discuss?`;
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          {brand?.logo
            ...
            : <span style={{ fontWeight: 900, fontSize: 15, color: '#fff', letterSpacing: '-0.02em' }}>{brand?.name || 'Glasstech'}</span>
          }
