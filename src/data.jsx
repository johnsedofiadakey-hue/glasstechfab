...
export const TEAM_MEMBERS = [
  {id:1,name:'Ama Asante',role:'Managing Director',bio:'15 years in industrial fabrication and glass engineering.',img:'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=400&q=80',av:'AA',email:'ama@glasstech.com.gh',phone:'+233 24 111 0001',status:'Online'},
  {id:2,name:'Kwame Osei',role:'Technical Lead',bio:'Expert in curtain wall systems and high-pressure glazing.',img:'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80',av:'KO',email:'kwame@glasstech.com.gh',phone:'+233 24 111 0002',status:'Online'},
  {id:3,name:'Abena Darko',role:'Site Supervisor',bio:'Ensures on-site precision and safety across all glass installations.',img:'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&q=80',av:'AD',email:'abena@glasstech.com.gh',phone:'+233 24 111 0003',status:'Idle'},
  {id:4,name:'Nana Boateng',role:'CAD Engineer',bio:'Specializes in precision technical drawings and fabrication specs.',img:'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&q=80',av:'NB',email:'nana@glasstech.com.gh',phone:'+233 24 111 0004',status:'Idle'},
];
